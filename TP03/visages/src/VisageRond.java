...
public class VisageRond {
     ...
     */
    public VisageRond(int xg, int yg, Dessin d) {
        this.d = d;
        xhg = xg;
        yhg = yg;
    ...
    /**
     * Donnerla valeur du déplacement élémentaire vertical.
     *
     ...
     *
     * @param v Valeur à affecter à dy, déplacement élémentaire vertical.
     */
     ...
     * @see java.awt.Graphics
     */
    private void dessinerVisage(Graphics g) {
     ...
     * @see java.awt.Graphics
     */
    private void dessinerYeux(Graphics g) {
        // dessiner les yeux
